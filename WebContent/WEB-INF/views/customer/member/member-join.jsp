					...
					<table class="table">
						<tbody>
							<tr class="tr">
								...
								<span style="color:green; font-family:a드림고딕5">${duplicatedResult}</span>
								</c:when>
								<c:when test="${not empty errorMsgIdNotInput}">
								<span style="color:green; font-family:a드림고딕5">${errorMsgIdNotInput}</span>
								</c:when>
								<c:when test="${not empty errorMsgIdNotChecked}">
								<span style="color:green; font-family:a드림고딕5">${errorMsgIdNotChecked}</span>
								</c:when>
								<c:when test="${not empty errorMsgIdNotCorrect}">
								<span style="color:green; font-family:a드림고딕5">${errorMsgIdNotCorrect}</span>
								</c:when>
							...
							<tr class="tr">
								...
								<span style="color:green; font-family:a드림고딕5">${errorMsgPwdNotMatch}</span>
								</c:if>
								</td>
							</tr>
							<tr class="tr">
